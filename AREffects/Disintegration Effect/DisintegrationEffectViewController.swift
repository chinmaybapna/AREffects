//
//  DisintegrationEffectViewController.swift
//  AREffects
//
...
class DisintegrationEffectViewController: UIViewController, ARSCNViewDelegate {

    @IBOutlet weak var sceneView: ARSCNView?
    @IBOutlet weak var recogniseLabel: UILabel!
    @IBOutlet weak var okButton: UIButton!
    @IBOutlet weak var instructionLabel: UILabel!
    @IBOutlet weak var referanceBoxImageView: UIImageView!
    ...
    var palmAppearedForTheFirstTime : Bool = true
    var fistAppearedForTheFirstTime : Bool = true
    ...
    override func viewDidLoad() {
        ...
        referanceBoxImageView.isHidden = true
    ...
    @IBAction func okButtonPressed(_ sender: Any) {
        ...
        referanceBoxImageView.isHidden = false
    }
    ...
    func loadAnimations () {
        ...
        let idleScene = SCNScene(named: "art.scnassets/explosion3.dae")!
        ...
        node.position = SCNVector3(0, -12, -40)
//        node.scale = SCNVector3(1, 1, 1)
    ...
    func classificationCompleteHandler(request: VNRequest, error: Error?) {
        ...
        DispatchQueue.main.async {
            ...
            //if confidence is above 30%
            let topPredictionScore:Float? = Float(topPrediction.components(separatedBy: ":")[1].trimmingCharacters(in: .whitespaces))
            if (topPredictionScore != nil && topPredictionScore! > 0.3) {
                if (topPredictionName == "FIVE-UB-RHand" && self.palmAppearedForTheFirstTime) {
                    ...
                    self.palmAppearedForTheFirstTime = false
                }
            }
